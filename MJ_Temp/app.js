...
export class Map {
    constructor(container) {
        ...
        const cameraLookAt = new THREE.Vector3(0, 0, 1);
    ...
    loadGLTF(path) {
        ...
        loader.load(path, (gltf) => {
            ...
            // update initial camera position and angle based on gltf
            ...
            const zOffset = size * Math.sin(angle);

            this.cameraManager.camera.position.set(center.x, center.y + 1500, center.z + 750);
