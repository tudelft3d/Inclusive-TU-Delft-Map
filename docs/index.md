...
- General information about the data pipeline used in the project in [Data Pipeline](data_pipeline.md).
- General information about the expected structure of data used in the project in [Data Structure](data_structure.md).
